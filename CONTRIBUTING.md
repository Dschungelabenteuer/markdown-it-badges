...
It looks like you're interested in contributing to markdown-it-badges, thank you so much! Whether
you are a novice or experienced contributor, this guide should help you going through the whole
process of submitting contributions.
...
free to create a
[new discussion](https://github.com/Dschungelabenteuer/markdown-it-badges/discussions).
...
```bash
# Using HTTPS
git clone https://github.com/your-username/markdown-it-badges.git

# Using SSH
git clone git@github.com:your-username/markdown-it-badges.git
```
...
The easiest way of working on this codebase is to rely on Vitest, it does not need any compilation
and you can therefore test your changes by adding relevant tests.
